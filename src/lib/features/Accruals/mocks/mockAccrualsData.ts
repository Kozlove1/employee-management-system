...
export const mockAccrualsData: AccrualWithDetails[] = [
	{
		...
		date_create: '2024-12-20T14:30',
		date_disband: '',

		// Расширенные поля AccrualWithDetails
		employee_name: 'Колногорова Оксана Викторовна',
	...
	},
	{
		...
		date_create: '2024-12-19T09:15',
		date_disband: '',

		employee_name: 'Ибрагимова Гузель Ильдаровна',
	...
	},
	{
		...
		department_guid: '86253ef6-4e33-11ee-9d85-00155de8647c',
		date_create: '2024-12-18T16:45',
		date_disband: '',

		employee_name: 'Петров Михаил Александрович',
	...
	},
	{
		...
		date_create: '2024-12-17T11:20',
		date_disband: '',

		employee_name: 'Сидорова Анна Сергеевна',
	...
	},
	{
		...
		department_guid: '86253ef6-4e33-11ee-9d85-00155de8647c',
		date_create: '2024-12-16T13:10',
		date_disband: '',

		employee_name: 'Иванов Дмитрий Петрович',
	...
	},
	{
		...
		post: 'Тестовая награда 2 - 300 АК',
		department_guid: '86253ef6-4e33-11ee-9d85-00155de8647c',
		date_create: '2024-12-15T10:30',
		date_disband: '',

		employee_name: 'Козлова Елена Владимировна',
	...
	},
	{
		...
		post: 'Тестовая награда 3 - 60 АК',
		department_guid: '86253b1a-4e33-11ee-9d85-00155de8647c',
		date_create: '2024-12-14T15:20',
		date_disband: '',

		employee_name: 'Федоров Алексей Николаевич',
	...
	},
	{
		...
		post: 'Бонус за качественную работу - 200 руб',
		department_guid: '86253ef6-4e33-11ee-9d85-00155de8647c',
		date_create: '2024-12-13T09:45',
		date_disband: '',

		employee_name: 'Морозова Татьяна Ивановна',
	...
	},
	{
		...
		post: 'Тестовая награда - 100 АК',
		department_guid: '86253e12-4e33-11ee-9d85-00155de8647c',
		date_create: '2024-12-12T14:15',
		date_disband: '',

		employee_name: 'Соколов Владимир Петрович',
	...
	},
	{
		...
		post: 'Премия за выслугу лет - 500 руб',
		department_guid: '86253ef6-4e33-11ee-9d85-00155de8647c',
		date_create: '2024-12-11T16:00',
		date_disband: '',

		employee_name: 'Новикова Мария Александровна',
